...
public class Transferencia {
    ...
    public Transferencia(String cuentaOrigen, String entidadDestino, String monto, String bancoOrigen,
            String bancoDestino, String transferenciasCol) {
